 ...
 * It contains a GameVector object in order to keep track
...
public class Pawn {
  ...
  {
    this.square = -1;
    this.position = new GameVector(-1,-1);
  ...
  public GameVector getPosition(){return this.position;}
  ...
  {
    this.square = 0;
    this.position = new GameVector(6,1);
  ...
  public void moveOnBoard(Map<Integer,GameVector> coords,int diceResult)
  {
