 ...
 * and also a map between the board's positions (2D GameVectors)
...
public class Player {
  ...
  public Map<Integer,GameVector> getMapPosition(){return this.mapPosition;}

  /***************************************************/

  public void setMap(Map<Integer,GameVector> map){this.mapPosition = map;}
